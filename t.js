...
//   options.addArguments("--headless");
  ...
  const url = 'https://www.linkedin.com/in/tuanpa2/';
  // Login to LinkedIn
  await driver.get('https://www.linkedin.com/login');
  await driver.manage().setTimeouts({ implicit: 5000 });
  const emailInput = await driver.findElement(By.id('username'));
  const passwordInput = await driver.findElement(By.id('password'));
  await emailInput.sendKeys('cosy.inc@gmail.com');// Add your LinkedIn email Address
  await passwordInput.sendKeys('cwdX6^P@X,(9/mi', Key.RETURN);// Add your LinkedIn Password
